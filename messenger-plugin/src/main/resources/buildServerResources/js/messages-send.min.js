(function(a){var b={dialog:function(d,c){a("#messages-send-dialog-text").text(d);a("#messages-send-dialog").dialog({height:40,width:180,close:b.dialogClose});c>0&&b.dialogClose.delay(c)},dialogClose:function(){a("#messages-send-dialog").dialog("destroy");a("#messages-send-message").val("").focus();a("#messages-send-button").enable()}};a(function(){a("#messages-send-message").focus();a("#messages-send-dialog-ok").click(function(){b.dialogClose();return!1});a("#messages-send-all").change(function(){a("#messages-send-groups, #messages-send-users").disable(this.value==
