...
final class Message
{
    ...
    */
    ...
    Message ( long id, MessagesContext context, MessagesConfiguration config, MessagesUtil util, Message message )
    {
        ...
        this.senderName   = context.getUser( message.sender )?.descriptiveName ?: 'Test/Guest User'
     ...
     * @see com.github.goldin.plugins.teamcity.messenger.controller.MessagesDisplayController#handleRequest
     */
     ...
     * @see com.github.goldin.plugins.teamcity.messenger.impl.MessagesPersistencyImpl#save
     */
