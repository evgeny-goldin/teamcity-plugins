...
import static com.github.goldin.plugins.teamcity.messenger.test.infra.Constants.*
import com.github.goldin.plugins.teamcity.messenger.api.Message
import com.github.goldin.plugins.teamcity.messenger.api.Message.Urgency
import com.github.goldin.plugins.teamcity.messenger.api.MessagesUtil
...
class MessagesUtilTest extends BaseSpecification
{
    ...
    def "testing HTML escaping with files"() {
        ...
        'htmlEscape-input2.html.txt' | 'htmlEscape-output2.html.txt'
    }
